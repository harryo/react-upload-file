...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ReactUploadFile = function (_React$PureComponent) {
	  _inherits(ReactUploadFile, _React$PureComponent);
	  ...
	  function ReactUploadFile(props) {
	    ...
	    _this.manuallyChooseFile = function (e) {
	      _this.commonChooseFile(e);
	    };
	...
	ReactUploadFile.propTypes = {
	  options: _propTypes2.default.shape({
	    ...
	    query: _propTypes2.default.oneOfType([_propTypes2.default.object, _propTypes2.default.func]),
	    body: _propTypes2.default.oneOfType([_propTypes2.default.object, _propTypes2.default.func]),
	    ...
	    didChoose: _propTypes2.default.func,
	    beforeUpload: _propTypes2.default.func,
	    didUpload: _propTypes2.default.func,
	  ...
	  /* buttons*/
	  chooseFileButton: _propTypes2.default.element.isRequired,
	  uploadFileButton: _propTypes2.default.element
	};
